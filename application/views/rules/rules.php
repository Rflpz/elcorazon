				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-unstyled">
							<li><i class="fa fa-question"></i><b>Address:</b> Domicilio Conocido El Naranjo, El Naranjo Manzanilo</li>
					...
					<ul class="top-links list-inline">
						<li>
							...
							<ul class="dropdown-langs dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1" href="../../es/rules/index.html"><img class="flag-lang" src="assets/images/flags/mx.png" width="16" height="11" alt="lang" /> SPANISH</a></li>
      ...
      <!--
			...
			<section class="page-header">
				<div class="container">
					...
					<h1>Rules of Access</h1>

					<!-- breadcrumbs -->
					<ol class="breadcrumb">
						<li><a href="../index.html">Home</a></li>
						<li class="active">Rules of Access</li>
					</ol><!-- /breadcrumbs -->
          ...
          <h2 class="col-sm-10 col-sm-offset-1 nomargin-bottom weight-400 size-25">Rules of Access</h2><br><br>
					<hr />
      <center>
