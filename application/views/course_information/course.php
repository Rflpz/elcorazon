		...
		<div id="wrapper">
					...
					<ul class="top-links list-inline">
						<li>
							...
							<ul class="dropdown-langs dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1" href="../../es/course_information/index.html"><img class="flag-lang" src="assets/images/flags/mx.png" width="16" height="11" alt="lang" /> SPANISH</a></li>
			...
			<section class="page-header page-header-2xlg parallax parallax-3" style="background-image:url('img/el_corazon_golf_Course_view1.jpg')">
				<div class="text-center">
					<h3 class="font-khausan-script nomargin weight-300"><span style="color:#D3D3D3">Course Information</span></h3>
				</div>
