					...
					<ul class="top-links list-inline">
						<li>
							...
							<ul class="dropdown-langs dropdown-menu">
								<li><a tabindex="-1" href="../../en/contact/index.html"><img class="flag-lang" src="assets/images/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a></li>
								<li class="divider"></li>
			...
			<section>
				...
				<div class="container">
					...
					<div class="contact-over-box">
						...
						<h3 class="size-20">Envianos tus <strong><em>Preguntas?</em></strong></h3>
						...
						<div id="alert_success" class="alert alert-success margin-bottom-30">
							...
							<strong>Gracias!</strong> Su mensaje fue enviado con exitosamente!
						</div><!-- /Alert Success -->
						...
						<div id="alert_mandatory" class="alert alert-danger margin-bottom-30">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<strong>Oops!</strong> Necesitas llenar todos los campos (*) obligatorios!
						</div><!-- /Alert Mandatory -->
