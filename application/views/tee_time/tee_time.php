			...
			<div id="topBar">
				<div class="container">
					...
					<ul class="top-links list-inline pull-right">
						...
						<li class="hidden-xs"><a href="../tee_time/index.html">LOGIN</a></li>
					...
					<ul class="top-links list-inline">
						<li>
							...
							<ul class="dropdown-langs dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1" href="../../es/tee_time/index.html"><img class="flag-lang" src="assets/images/flags/mx.png" width="16" height="11" alt="lang" /> SPANISH</a></li>
