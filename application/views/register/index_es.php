			...
			<div id="topBar">
				<div class="container">
					...
					<ul class="top-links list-inline pull-right">
						...
						<li class="hidden-xs"><a href="#">CREAR CUENTA</a></li>
					</ul>
					...
					<ul class="top-links list-inline">
						<li>
							...
							<ul class="dropdown-langs dropdown-menu">
								<li><a tabindex="-1" href="../../en/register/index.html"><img class="flag-lang" src="assets/images/flags/us.png" width="16" height="11" alt="lang" /> ENGLISH</a></li>
								<li class="divider"></li>
