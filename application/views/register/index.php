				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-unstyled">
							<li><b>Address:</b> Domicilio Conocido El Naranjo, El Naranjo Manzanilo</li>
							<li><b>Phone:</b> 314-133-7940</li>
			...
			<div id="topBar">
				<div class="container">
					...
					<ul class="top-links list-inline pull-right">
						...
						<li class="hidden-xs"><a href="#">REGISTER</a></li>
					</ul>
					...
					<ul class="top-links list-inline">
						<li>
							...
							<ul class="dropdown-langs dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1" href="../../es/register/index.html"><img class="flag-lang" src="assets/images/flags/mx.png" width="16" height="11" alt="lang" /> SPANISH</a></li>
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3">
							...
							<div class="toggle toggle-transparent toggle-accordion toggle-noicon">
								...
								<div class="toggle">
									<label class="size-20"><i class="fa fa-users"></i> &nbsp; I'm a member</label>
								...
								<div class="toggle active">
									<label class="size-20"><i class="fa fa-user-plus"></i> &nbsp; Not a member yet?</label>
									<div class="toggle-content">
